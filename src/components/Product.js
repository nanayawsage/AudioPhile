    ...
    <div style={styles.container}>
              ...
              {categories.map((category) => {
                ...
                return (
                  <button
                    ...
                    onMouseEnter={(e) => handleCategoryButtonHover(e, true, isActive)}
                    onMouseLeave={(e) => handleCategoryButtonHover(e, false, isActive)}
                  >
      ...
      <div style={styles.productsSection}>
        ...
        {filteredProducts.length === 0 && (
          <div style={styles.emptyState}>
            ...
            <p style={styles.emptyStateText}>Try selecting a different category</p>
          </div>
        )}
      </div>
      ...
      <div style={styles.footer}>
        <div style={styles.footerContent}>
          <h3 style={styles.footerTitle}>Ready to upgrade your audio experience?</h3>
          <p style={styles.footerText}>Discover our full range of premium audio equipment</p>
          <button 
