...
const Speakers = ({ onAddToCart }) => {
  ...
  // Calculate stats
  const avgPrice = Math.round(speakers.reduce((sum, p) => sum + p.price, 0) / speakers.length);
    ...
    <div style={styles.container}>
        ...
        <div style={styles.headerContent}>
          <div style={styles.headerText}>
            ...
            <p style={styles.subtitle}>
              Transform your space with powerful, wireless speakers that deliver exceptional audio quality for home and studio use
            </p>
      ...
      <div style={styles.footer}>
        <div style={styles.footerContent}>
          ...
          <p style={styles.footerText}>Professional-grade speakers for the ultimate audio experience</p>
          <button 
